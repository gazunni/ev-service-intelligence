...
function vehicleImagePath(vehicleKey, year) {
  ...
  const byYear = {
    equinox_ev: {
      2025: '/images/vehicles/equinox-ev.jpg',
      2026: '/images/vehicles/equinox-ev.jpg',
    },
    bolt_ev_gen2: {
      2027: '/images/vehicles/2027_bolt_euv_bronze.jpg',
      2028: '/images/vehicles/2027_bolt_euv_bronze.jpg',
      2029: '/images/vehicles/2027_bolt_euv_bronze.jpg',
      2030: '/images/vehicles/2027_bolt_euv_bronze.jpg',
    },
  };

  if (Number.isInteger(y) && byYear[vehicleKey]?.[y]) return byYear[vehicleKey][y];

  const defaults = {
    bolt_ev: '/images/vehicles/bolt_ev_silver.jpg',
    bolt_euv: '/images/vehicles/bolt_euv_blue.jpg',
    bolt_ev_gen2: '/images/vehicles/2027_bolt_euv_bronze.jpg',
    blazer_ev: '/images/vehicles/chevrolet_blazer_ev.jpg',
    honda_prologue: '/images/vehicles/honda_prologue.jpg',
    tesla_model_3: '/images/vehicles/tesla_model_3.jpg',
    tesla_model_y: '/images/vehicles/tesla_model_y.jpg',
    mach_e: '/images/vehicles/ford_mustang_mach_e.jpg',
  };

  if (defaults[vehicleKey]) return defaults[vehicleKey];
