...
function logoMarkup() {
  return `<div class="report-logo" aria-label="Generify logo">
    <div class="report-logo-ring">
      <span>GENERIFY</span>
      <span>DATA INTELLIGENCE</span>
    </div>
    <div class="report-logo-core">◈</div>
  </div>`;
}
...
.hero{background:${theme.hero};color:white;padding:24px 28px 30px;position:relative}.hero-top{display:flex;justify-content:space-between;gap:20px;align-items:flex-start}.brand-lockup{display:flex;gap:14px;align-items:center}.report-logo{width:82px;height:82px;border-radius:50%;position:relative;background:#020617;display:grid;place-items:center;box-shadow:0 0 0 2px rgba(191,219,254,.25),0 0 28px rgba(56,189,248,.35)}.report-logo-ring{position:absolute;inset:6px;border-radius:50%;border:2px solid rgba(96,165,250,.85);display:flex;flex-direction:column;justify-content:space-between;padding:8px 0;font-size:7px;letter-spacing:.22em;font-weight:700;color:#bfdbfe;align-items:center;text-transform:uppercase}.report-logo-core{font-size:28px;color:#67e8f9;text-shadow:0 0 12px rgba(103,232,249,.85)}.brand-title{font-size:14px;letter-spacing:.18em;text-transform:uppercase;opacity:.92;font-weight:700}.brand-sub{font-size:30px;line-height:1.05;font-weight:800;margin-top:6px}.brand-power{margin-top:6px;color:#dbeafe;font-size:13px}.hero-meta{text-align:right;font-size:13px;color:#dbeafe}.hero-grid{display:grid;grid-template-columns:1.2fr .8fr;gap:18px;align-items:stretch;margin-top:20px}.vehicle-art{min-height:220px;border-radius:22px;background:linear-gradient(135deg, rgba(255,255,255,.16), rgba(15,23,42,.32));border:1px solid rgba(255,255,255,.18);display:flex;flex-direction:column;justify-content:flex-end;padding:18px;position:relative;overflow:hidden}.vehicle-art:before{content:'';position:absolute;inset:18px;border-radius:18px;border:1px solid rgba(191,219,254,.25)}.vehicle-art:after{content:'';position:absolute;width:220px;height:220px;border-radius:50%;right:-40px;top:-60px;background:radial-gradient(circle, rgba(255,255,255,.22), rgba(255,255,255,0));}.vehicle-art-badge{font-size:11px;letter-spacing:.12em;text-transform:uppercase;color:#bfdbfe;position:relative}.vehicle-art-name{font-size:26px;font-weight:800;position:relative;margin-top:10px}.identity-card{background:rgba(248,250,252,.98);color:var(--ink);border-radius:22px;padding:20px;border:1px solid rgba(255,255,255,.4)}.identity-card h3{margin:0 0 10px;font-size:24px}.identity-grid{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:10px 16px}.identity-item{border-top:1px solid #dbeafe;padding-top:8px}.identity-label{font-size:11px;color:#64748b;text-transform:uppercase;letter-spacing:.12em}.identity-val{font-size:14px;font-weight:700;margin-top:2px}.context-note{margin-top:12px;padding:10px 12px;border-radius:12px;background:${matchConfirmed ? 'rgba(22,101,52,.12)' : 'rgba(180,83,9,.12)'};color:${matchConfirmed ? '#dcfce7' : '#ffedd5'};font-size:12px;border:1px solid ${matchConfirmed ? 'rgba(34,197,94,.25)' : 'rgba(251,146,60,.25)'}}
